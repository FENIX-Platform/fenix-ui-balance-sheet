define(["jquery", "fx-balance-sheet/editor/cell/CellEditor", "fx-balance-sheet/formatter/DatatypesFormatter",
    "fx-balance-sheet/validator/EditorValidator"], function ($, CellEditor, DatatypeFormatter, Validator) {
    ...
    function FormEditorHandler() {

        FormEditor = new CellEditor;
        Formatter = new DatatypeFormatter;
    }

    FormEditorHandler.prototype.init = function (Configurator, cell, dsd) {
    ...
    FormEditorHandler.prototype.getValue = function (cell) {
    ...
    FormEditorHandler.prototype.checkValuesChanged = function (input, cell) {
